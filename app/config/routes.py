...
routes['GET']['/dashboard'] = 'Travels#dashboard'
routes['GET']['/logout'] = 'Users#logout'
routes['POST']['/process_registration'] = 'Users#process_registration'
routes['GET']['/travel/add'] = 'Travels#add_travel'
routes['POST']['/add_plan'] = 'Travels#add_plan'
routes['GET']['/details/<id>'] = 'Travels#details'
routes['GET']['/join/<id>'] = 'Travels#join_trip'
"""
